      ...
      /* @__PURE__ */ jsxs("section", { className: "flex flex-col gap-10", children: [
        ...
        /* @__PURE__ */ jsx(
          "p",
          {
            ...
            children: "Na Otologic, oferecemos uma ampla gama de exames especializados em Otorrinolaringologia e Audiologia, garantindo diagnósticos precisos e um atendimento de excelência."
          }
        ),
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, children: exams.map((exam) => /* @__PURE__ */ jsxs(AccordionItem, { value: exam.title, children: [
              /* @__PURE__ */ jsx(AccordionTrigger, { className: "text-left text-base font-bold text-blue-tertiary", children: exam.title }),
