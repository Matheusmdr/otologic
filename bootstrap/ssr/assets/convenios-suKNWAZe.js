      ...
      /* @__PURE__ */ jsxs("section", { className: "flex flex-col gap-10", children: [
        ...
        /* @__PURE__ */ jsx(
          "p",
          {
            ...
            children: "Atendemos os mais diversos convênios de saúde."
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "mx-auto grid w-10/12 max-w-5xl grid-cols-2 place-items-center items-center justify-center justify-items-center gap-12 md:grid-cols-4 md:gap-28", children: healthInsurances.map((healthInsurance, index) => /* @__PURE__ */ jsx(
          "img",
          {
