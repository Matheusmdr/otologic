      ...
      /* @__PURE__ */ jsxs("section", { className: "flex flex-col gap-10", children: [
        /* @__PURE__ */ jsx("div", { className: "mx-auto flex w-11/12 max-w-7xl flex-col justify-center gap-10", children: /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("h2", { className: "mx-auto w-fit px-2 py-1 text-center text-xl font-bold text-white", children: "Corpo Clínico" })
          }
        ) }),
        /* @__PURE__ */ jsx("p", { className: "mx-auto max-w-2xl px-4 text-center text-base font-medium text-white", children: "Na Otologic, contamos com uma equipe de especialistas em otorrinolaringologia e audiologia, altamente qualificada e dedicada ao cuidado integral da sua saúde." }),
