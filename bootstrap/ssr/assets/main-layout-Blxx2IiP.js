...
import { B as Button, c as cn } from "./button-weNgVMLy.js";
        ...
        /* @__PURE__ */ jsxs("div", { className: "mx-auto flex w-full flex-col justify-center gap-4 md:max-w-3xl md:flex-row md:items-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 text-[8px] font-bold text-white md:text-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between gap-2 md:flex-row md:gap-4", children: [
              ...
              /* @__PURE__ */ jsx(Link, { href: "/exames", className: "hover:text-white/80", children: "Nossa Clínica" }),
              /* @__PURE__ */ jsx("span", { className: "hidden md:block", children: "|" }),
              /* @__PURE__ */ jsx(Link, { href: "/corpo-clinico", className: "hover:text-white/80", children: "Nossos Exames" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 md:flex-row md:gap-4", children: [
              /* @__PURE__ */ jsx(Link, { href: "/unidades", className: "hover:text-white/80", children: "Corpo Clínico" }),
              /* @__PURE__ */ jsx("span", { className: "hidden md:block", children: "|" }),
              /* @__PURE__ */ jsx(Link, { href: "/convenios", className: "hover:text-white/80", children: "Notícias" }),
              /* @__PURE__ */ jsx("span", { className: "hidden md:block", children: "|" }),
              /* @__PURE__ */ jsx(Link, { href: "/fale-conosco", className: "hover:text-white/80", children: "Convênios Atendidos" })
            ] })
          ] })
        ] }),
...
function WhatsappButton({ className }) {
  return /* @__PURE__ */ jsx(Link, { href: "/agendamento", target: "_blank", rel: "noreferrer noopener", children: /* @__PURE__ */ jsx(
    Button,
    {
      className: cn(
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4", children: [
              /* @__PURE__ */ jsx("a", { href: "#", target: "_blank", rel: "noreferrer noopener", children: /* @__PURE__ */ jsx("img", { src: "/imgs/social/instagram.svg" }) }),
              /* @__PURE__ */ jsx("a", { href: "#", target: "_blank", rel: "noreferrer noopener", children: /* @__PURE__ */ jsx("img", { src: "/imgs/social/facebook.svg" }) })
            ] })
          ] })
        ] })
      }
