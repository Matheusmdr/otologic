...
function Page() {
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Agendamento" }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "flex flex-col gap-10", children: [
        ...
        /* @__PURE__ */ jsx(
          "p",
          {
            ...
            children: "Faça seu agendamento de exame ou consulta através do nosso WhatsApp ou telefone fixo."
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-10", children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              "data-aos-delay": "300",
              children: [
                /* @__PURE__ */ jsx("span", { className: "inline-flex items-center justify-center gap-2 text-lg font-bold text-blue-primary", children: "Ligações e Whatsapp" }),
                /* @__PURE__ */ jsxs(
                  "a",
                  {
