      ...
      /* @__PURE__ */ jsx("section", { className: "flex flex-col gap-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex w-11/12 max-w-5xl flex-col justify-center gap-2 md:gap-6", children: [
        ...
        /* @__PURE__ */ jsx(
          "p",
          {
            ...
            children: "Fique por dentro de todas as notícias sobre cuidados com a sua saúde!"
          }
        ),
        /* @__PURE__ */ jsx("div", { children: data.map((newsItem, index) => /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              "data-aos": "fade-up",
