  ...
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { className: "space-y-10 bg-white py-10 md:space-y-20 md:py-20", children: [
      /* @__PURE__ */ jsxs("section", { className: "flex flex-col gap-10", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mx-auto max-w-2xl px-4 text-center text-base font-medium text-[#757575]", children: "Na Otologic, oferecemos uma ampla gama de exames especializados em Otorrinolaringologia e Audiologia, garantindo diagnósticos precisos e um atendimento de excelência." }),
