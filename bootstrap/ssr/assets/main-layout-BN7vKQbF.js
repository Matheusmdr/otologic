    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mx-auto flex w-11/12 max-w-5xl items-center justify-between py-4", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: "tel:+5518996812001", target: "_blank", rel: "noreferrer noopener", children: /* @__PURE__ */ jsx(Button, { className: "rounded-3xl border-2 border-white bg-blue-primary text-xl text-white hover:bg-white hover:text-blue-primary", children: "18 99681-2001" }) })
        ] }),
